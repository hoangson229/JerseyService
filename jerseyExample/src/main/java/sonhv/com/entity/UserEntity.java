...
public class UserEntity implements Serializable {
	...
	@Id
	// @GenericGenerator(name = "seq_users", strategy =
	// "com.mcredit.data.common.entity.SequenceGenerate", parameters =
	// @Parameter(name = "seqName", value = "SEQ_USERS_ID.NEXTVAL"))
